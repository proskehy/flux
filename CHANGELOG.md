...
`kubectl` and `kustomize`, de-experimental-ises garbage collection,
namespace scoping, and manifest generation, and does a lot of internal
rewiring _without_ changing user-visible functions or the public APIs.
...
- Build: ensure generated template modtimes are Unix epoch
  [fluxcd/flux#2473][]
...
- Documentation: fix wrongly documented Helm chart repository
  [fluxcd/flux#2484][]
